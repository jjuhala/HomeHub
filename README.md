...
If you're interested in building a wireless home automation system yourself you've come to right place.
HomeHub is a open source home automation project built with C++ (Arduino), PHP+MySQL (Server), HTML5 etc (Frontend).


#### Please note that HomeHub is a work-in-process and is not anywhere near being ready.
#### At the moment it's in a very early stage and this read me is more of a description of what it will be.
#### Because of such an early development stage I wont list which features work and which dont.
...
* Ready support for
  ...
  * Beeper
  * Additional buttons for any actions (ie. button to shut TV off, turn music on and put lights on)
  * XBMC support
  * Infrared support to control TV or anything that has IR remote
...
* Keyboard shortcuts for Windows machines
